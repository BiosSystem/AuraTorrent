...
Everything below this line is the changelog inherited from upstream VueTorrent at the point AuraTorrent was forked. It is kept for reference and is not part of AuraTorrent's own release history. AuraTorrent's own versioning starts at 1.3.0, the version number carried over from the fork point; that starting version has no changelog entry of its own since changelog tracking began with the 1.4.0 release.
