...
function downloadSettings() {
  ...
  downloadFile(`AuraTorrent_${currentVersion}_${currentTimestamp}.json`, blob)
}
      ...
      <v-row>
        <v-col cols="6" class="d-flex align-center justify-center">
          <h3>
            ...
            <a v-else-if="vueTorrentVersion === 'DEV'" target="_blank" href="https://github.com/BiosSystem/AuraTorrent">{{ vueTorrentVersion }}</a>
            <a v-else-if="isStableVersion" target="_blank" href="https://github.com/BiosSystem/AuraTorrent/releases/latest">{{ vueTorrentVersion }}</a>
            <a v-else target="_blank" href="https://github.com/BiosSystem/AuraTorrent/releases/tag/latest_nightly">{{ vueTorrentVersion }}</a>
          </h3>
        </v-col>
